  ...
  module Merchant
    ...
    def find_merchants(options={})
      ...
      if full_response.to_s.to_bool
        ...
        merchants_response.response.results.merchants if merchants_response.response
      end
    ...
    def find_merchant_types(options={})
      ...
      if full_response.to_s.to_bool
        ...
        merchant_types_response.response.results.merchant_types if merchant_types_response.response
      end
    end
